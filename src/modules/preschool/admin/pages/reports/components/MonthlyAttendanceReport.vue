  ...
  <div class="space-y-6">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      <h2 class="text-lg font-bold text-slate-900">
        {{ t('preschoolAttendanceReportPage.reports.monthly.title') || 'Monthly Attendance Report' }}
      </h2>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div class="overflow-x-auto">
        ...
        >
          ...
          <!-- Student Name -->
          <Column field="student.fullName" :header="t('preschoolAttendanceReportPage.table.student') || 'Name'" />

          <!-- Present -->
          <Column field="present" :header="t('preschoolAttendanceReportPage.table.present') || 'P'" />

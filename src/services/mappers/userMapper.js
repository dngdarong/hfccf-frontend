...
export function mapUser(raw = {}) {
  ...
  return {
    ...
    passwordChangedAt: raw.passwordChangedAt || raw.password_changed_at || '',
    lastPasswordResetAt: raw.lastPasswordResetAt || raw.last_password_reset_at || '',
    lastPasswordResetBy: raw.lastPasswordResetBy || raw.last_password_reset_by || '',
